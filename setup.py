...
class CMakeBuild(build_ext):
    ...
    def build_extension(self, ext):
        ...
        proton_dialect_src = os.path.join(self.base_dir, "third_party",
                                          "proton", "Dialect", "include")
        proton_dialect_dst = os.path.join(include_dst, "third_party", "proton",
                                          "Dialect", "include")
        ...
        if os.path.exists(proton_build_inc):
            shutil.copytree(proton_build_inc, proton_dialect_dst,
                            dirs_exist_ok=True)
